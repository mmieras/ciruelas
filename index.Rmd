...
Vinos_Mosto <- read_delim("Ciruela.csv", ";", escape_double = FALSE, trim_ws = TRUE)

Vinos_Mosto <- as.matrix(Vinos_Mosto)
Vinos_Mosto <- Vinos_Mosto/1000000


Zonas <- read_delim("Zonas.csv",";", escape_double = FALSE, trim_ws = TRUE)
...
[Matriz Origen Destino](Ciruela.csv)
[Centros Urbanos Nodos](Zonas.csv)
[Fuente del Proyecto](index.Rmd)
